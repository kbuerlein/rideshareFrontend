...
extension AvailableRideVC: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let i = indexPath.row
        cell.configure(ride_id: rides[i].ride_id, driver_id: rides[i].driver_id, first_name: rides[i].first_name, last_name: rides[i].last_name, origin: rides[i].origin, destination: rides[i].destination, departure_time: rides[i].departure_time, available_seats: rides[i].available_seats, bookings: rides[i].bookings)
        return cell
    }
}
